...
// Importe o hook useParams para ler os parâmetros da URL
    ...
    const navigate = useNavigate();
      ...
      useEffect(() => {
        ...
        // --- CONTROLES ---
          ...
          // MUDANÇA #1: A função handleConcluirFase foi movida para antes do useEffect que a utiliza.
          ...
          // MUDANÇA #2: handleConcluirFase foi adicionada ao array de dependências.
          ...
          }, [estadoJogo, id_jogador, mundo_id, fase_id, dicasTotaisUsadas]);

          const handlePausar = () => setEstadoJogo(estadoJogo === 'jogando' ? 'pausado' : 'jogando');
          const handleRetry = () => inicializarFase();
          const handleAvancar = () => {
            navigate(`/mundo/${mundo_id}/fase/${proxima_fase_id}`, { state: { id_jogador } });
          };
