...
function seedDatabase() {
  db.get("SELECT COUNT(*) AS count FROM fases", (err, row) => {
    ...
    const itensPorFase = [
      ...
      { mundo: 2, fase: 3, nome: 'LARANJADA', dica1: 'Começa com "LA" e termina com "DA".', dica2: 'É uma palavra com 4 sílabas.', imagem_url: '/laranjada.svg' },
      ...
      { mundo: 2, fase: 4, nome: 'IOGURTE', dica1: 'É uma palavra com 7 letras.', dica2: 'Termina com a sílaba "TE".', imagem_url: '/iogurte.svg' },
    ...
    const cruzadinhasData = [
        ...
        //FASE 2
        { mundo: 3, fase: 2, palavra: 'VELA', dica: 'Ilumina o bolo de aniversário.', x: 1, y: 0, orientacao: 'horizontal' },
        { mundo: 3, fase: 2, palavra: 'LAÇO', dica: 'Um nó bonito feito com fita.', x: 3, y: 0, orientacao: 'vertical' },
        { mundo: 3, fase: 2, palavra: 'PAINEL', dica: 'Fica na parede atrás da mesa do bolo.', x: 2, y: 1, orientacao: 'horizontal' },
        { mundo: 3, fase: 2, palavra: 'LÂMPADA', dica: 'Objeto que produz luz.', x: 7, y: 1, orientacao: 'vertical' },
        { mundo: 3, fase: 2, palavra: 'BANDEIRA', dica: 'Pedaço de pano colorido para enfeitar.', x: 0, y: 5, orientacao: 'horizontal' },
        //FASE 3
        { mundo: 3, fase: 3, palavra: 'BALÃO', dica: 'Leve e cheio de ar, flutua na festa.', x: 6, y: 0, orientacao: 'vertical' },
        { mundo: 3, fase: 3, palavra: 'ESTRELA', dica: 'Brilha no céu e também em decorações.', x: 0, y: 1, orientacao: 'horizontal' },
        { mundo: 3, fase: 3, palavra: 'CORDA', dica: 'Usada para amarrar ou pendurar coisas.', x: 1, y: 6, orientacao: 'horizontal' },
        { mundo: 3, fase: 3, palavra: 'TECIDO', dica: 'Pano usado para fazer toalhas de mesa.', x: 2, y: 1, orientacao: 'vertical' },
        { mundo: 3, fase: 3, palavra: 'GUIZO', dica: 'Pequena esfera de metal que faz barulho.', x: 0, y: 4, orientacao: 'horizontal' },
        //FASE 4
        { mundo: 3, fase: 4, palavra: 'GLITTER', dica: 'Pó brilhante usado para decorar.', x: 1, y: 7, orientacao: 'horizontal' },
        { mundo: 3, fase: 4, palavra: 'POMPOM', dica: 'Bolinha fofa de lã ou papel.', x: 2, y: 2, orientacao: 'horizontal' },
        { mundo: 3, fase: 4, palavra: 'FITAS', dica: 'Tiras compridas e coloridas para enfeitar.', x: 6, y: 4, orientacao: 'horizontal' },
        { mundo: 3, fase: 4, palavra: 'LUZES', dica: 'Fios com pequenas lâmpadas que acendem.', x: 10, y: 0, orientacao: 'vertical' },
        { mundo: 3, fase: 4, palavra: 'LANTEJOULA', dica: 'Pequeno disco brilhante para costurar em roupas.', x: 3, y: 6, orientacao: 'horizontal' },
        { mundo: 3, fase: 4, palavra: 'CONFETE', dica: 'Pequenos pedaços de papel coloridos jogados em festas.', x: 6, y: 1, orientacao: 'vertical' },
        { mundo: 3, fase: 4, palavra: 'GUIRLANDA', dica: 'Círculo de flores ou ramos para enfeitar portas.', x: 0, y: 3, orientacao: 'horizontal' },
        //FASE 5
